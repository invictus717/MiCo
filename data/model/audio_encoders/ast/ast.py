...
class AudioEmbeddings(nn.Module):
    def __init__(self, model_cfg_audio):
        super().__init__()
        
        self.patch_size = 16
  

        self.token_length_per_frame = (model_cfg_audio.audio_melbins // self.patch_size) * (model_cfg_audio.audio_target_length // self.patch_size)
